...
def write_chat_format(reasoning_strategy, data_sect, data):
    ...
    for idx in data:
        ...
        #     print("-------------")
    write_json(f"./test_data/{data_sect}_sample.json", llama_data)
...
def parse_args():
    ...
    # Add arguments
    parser.add_argument("algorithm", type=str, default='bfs', choices=['bfs', 'dfs', 'dijkstra', 'floyd_warshall', 'mst_prim'], 
    ...
    parser.add_argument("-graph_sizes", "--graph_sizes", type=list, default=[3,5,8,10], help="Number of nodes present in the graphs generated. Default behavior sets num_samples to the number of training datapoints.")
    parser.add_argument("-num_samples", "--num_samples", type=int, default=5, help="Number of data samples to generate.")
    ...
    parser.add_argument("-output_dir", "--output_dir", type=str, default="./test_data", help="Output directory. Will create folders named after the algorithm for which data is generated.")
